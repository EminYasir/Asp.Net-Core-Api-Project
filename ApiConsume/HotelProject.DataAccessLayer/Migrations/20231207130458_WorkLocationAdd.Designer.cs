...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20231207130458_WorkLocationAdd")]
    partial class WorkLocationAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Guest", b =>
                {
                    ...
                    b.ToTable("Guests", null, t =>
                        {
                            t.HasTrigger("Customerdecrease");

                            t.HasTrigger("Customerincrease");
                        });
                });
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.WorkLocation", "MyProperty")
                        .WithMany("AppUsers")
