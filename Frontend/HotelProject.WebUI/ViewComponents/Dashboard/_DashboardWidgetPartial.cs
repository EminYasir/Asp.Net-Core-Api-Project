...
namespace HotelProject.WebUI.ViewComponents.Dashboard
{
    public class _DashboardWidgetPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responsMessage = await client.GetAsync("http://hotelier.somee.com/api/DashboardWidget/StaffCount");
            ...
            var responsMessage2 = await client2.GetAsync("http://hotelier.somee.com/api/DashboardWidget/BookingCount");
            ...
            var responsMessage3 = await client3.GetAsync("http://hotelier.somee.com/api/DashboardWidget/GuestCount");
            ...
            var responsMessage4 = await client4.GetAsync("http://hotelier.somee.com/api/DashboardWidget/RoomCount");
